  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-2 rounded-2xl p-6" style={cardStyle}>
          ...
          <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <dt className="text-xs" style={{ color: "#B0B0B0" }}>Address</dt>
              <dd className="text-sm font-medium mt-0.5 text-white">
                {venue.address ?? "—"}
              </dd>
            </div>
            <div>
              <dt className="text-xs" style={{ color: "#B0B0B0" }}>City</dt>
              <dd className="text-sm font-medium mt-0.5 text-white">
                {venue.city ?? "—"}
              </dd>
            </div>
            <div>
              <dt className="text-xs" style={{ color: "#B0B0B0" }}>Operating Hours</dt>
              <dd className="text-sm font-medium mt-0.5 text-white">
                {operatingHours}
              </dd>
            </div>
            <div>
              <dt className="text-xs" style={{ color: "#B0B0B0" }}>Status</dt>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div>
              <p className="text-xs" style={{ color: "#B0B0B0" }}>Active Members</p>
              <p
          ...
          >
            ...
            <div>
              <p className="text-xs" style={{ color: "#B0B0B0" }}>Monthly Entries</p>
              <p
                className="text-xl font-bold text-white tabular-nums"
                style={{ fontFamily: "Inter Tight, sans-serif" }}
              >
          ...
          >
            ...
            <div>
              <p className="text-xs" style={{ color: "#B0B0B0" }}>Screens</p>
              <p
                className="text-xl font-bold text-white tabular-nums"
                style={{ fontFamily: "Inter Tight, sans-serif" }}
              >
      ...
      >
        ...
        {revenue.length === 0 ? (
          <div className="px-6 py-8 text-center text-sm" style={{ color: "#B0B0B0" }}>
          ...
          <table className="w-full">
            <thead>
              <tr style={{ background: "rgba(255,255,255,0.04)", backdropFilter: "blur(6px)", WebkitBackdropFilter: "blur(6px)" }}>
                <th className="text-left px-6 py-3 text-xs font-semibold uppercase tracking-wider" style={{ color: "#B0B0B0" }}>
                  Month
                </th>
                <th className="text-right px-6 py-3 text-xs font-semibold uppercase tracking-wider" style={{ color: "#B0B0B0" }}>
                  Revenue
                </th>
              </tr>
            </thead>
      ...
      <div>
        ...
        {photosWithUrls.length === 0 ? (
          <div
            ...
            style={cardStyle}
          >
            <p style={{ color: "#B0B0B0" }}>No approved photos yet.</p>
          </div>
        ) : (
